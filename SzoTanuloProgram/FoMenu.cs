...
namespace SzoTanuloProgram
{
    public partial class FoMenu : Form
    {
        ...
        public static bool felelet = false;
        ...
        private void FoMenu_Load(object sender, EventArgs e)
        {
            ...
            pictureBox2_0.ImageLocation = "questionmark.jpg";
            pictureBox2_1.ImageLocation = "questionmark.jpg";
            pictureBox3_0.ImageLocation = "flags\\" + "hun_flag.jpg";
            pictureBox3_1.ImageLocation = "flags\\" + "english_flag.jpg";
            pictureBox4_0.ImageLocation = "flags\\" + "minijatek.jpg";
            pictureBox4_1.ImageLocation = "flags\\" + "minijatek.jpg";
        }
        ...
        {
            pictureBox0_0.Visible = true;
            pictureBox0_1.Visible = true;
        ...
        {
            pictureBox0_0.Visible = false;
            pictureBox0_1.Visible = false;
        ...
        {
            pictureBox3_0.Visible = true;
            pictureBox3_1.Visible = true;
            richTextBox3.BackColor = Color.FromArgb(227, 218, 201);
            richTextBox3.SelectionAlignment = HorizontalAlignment.Center;
            richTextBox3.Text = "Magyar szavak jelennek meg és a szótár szerinti angól párját kell beírni karakterhelyesen!";
        }

        private void button4_MouseLeave(object sender, EventArgs e)
        {
            pictureBox3_0.Visible = false;
        ...
        {
            pictureBox4_0.Visible = true;
            pictureBox4_1.Visible = true;
            richTextBox4.BackColor = Color.FromArgb(227, 218, 201);
            richTextBox4.SelectionAlignment = HorizontalAlignment.Center;
            richTextBox4.Text = "Szó pár kereső játék, ehhez a módhoz legalább 10 szavas szójegyzék kell!";
        }

        private void button5_MouseLeave(object sender, EventArgs e)
        {
            pictureBox4_0.Visible = false;
            pictureBox4_1.Visible = false;
